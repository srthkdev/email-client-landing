  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-sm max-w-none">
        <p>
          This Privacy Policy outlines our practices and policies concerning the gathering, use, and disclosure of your
          Personal Data while using the Service. It also informs you about your privacy rights and legal protections.
          We use the Personal Data to deliver and enhance the Service. Your use of the Service implies your consent to our
          collection and use of your Personal Data as outlined in this Privacy Policy.
        </p>
        <p>
          This Privacy Policy has been created with the aid of the Free Privacy Policy Generator.
        </p>
        ...
        <p>
          The capitalized words shall have the meanings defined under the following conditions. The following definitions
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>&ldquo;Account&rdquo;</strong> means a unique account created for You to access our Service or parts of our Service.
          </li>
          <li>
            <strong>&ldquo;Affiliate&rdquo;</strong> means an entity that controls, is controlled by or is under common control with a party, where
            &ldquo;control&rdquo; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of
            directors or other managing authority.
          </li>
          <li>
            <strong>&ldquo;Company&rdquo;</strong> (referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers
            to https://venn-jbnl.vercel.app/.
          </li>
          <li>
            <strong>&ldquo;Cookies&rdquo;</strong> are small files that are placed on Your computer, mobile device or any other device by a website,
            containing the details of Your browsing history on that website among its many uses.
          </li>
          <li>
            <strong>&ldquo;Country&rdquo;</strong> refers to: West Bengal, India.
          </li>
          <li>
            <strong>&ldquo;Device&rdquo;</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.
          </li>
          <li>
            <strong>&ldquo;Personal Data&rdquo;</strong> is any information that relates to an identified or identifiable individual.
          </li>
          <li>
            <strong>&ldquo;Service&rdquo;</strong> refers to the Website.
          </li>
          <li>
            <strong>&ldquo;Service Provider&rdquo;</strong> means any natural or legal person who processes the data on behalf of the Company. It refers
            to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on
            behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the
            Service is used.
          </li>
          <li>
            <strong>&ldquo;Usage Data&rdquo;</strong> refers to data collected automatically, either generated by the use of the Service or from the Service
            infrastructure itself (for example, the duration of a page visit).
          </li>
          <li>
            <strong>&ldquo;Website&rdquo;</strong> refers to Venn, accessible from https://venn-jbnl.vercel.app/
          </li>
          <li>
            <strong>&ldquo;You&rdquo;</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which
        ...
        <p>
          ...
          used to identify You or contact You. Personally identifiable information may include, but is not limited to:
        </p>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <h4 className="text-lg font-bold mt-4 mb-2">Data Usage</h4>
        <p>
          The Service automatically gathers usage data during its use. This data may encompass details such as your device&apos;s
          Internet Protocol (IP) address, browser type, browser version, the specific pages of our Service you visit, the date
          and time of your visit, duration spent on those pages, unique device identifiers, and other diagnostic information.
          When accessing the Service through a mobile device, we may automatically collect certain details including, but not
          limited to, the model of your mobile device, its unique ID, the IP address associated with it, your mobile operating
          system, the type of mobile internet browser you utilize, unique device identifiers, and additional diagnostic data.
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>To provide You with special offers</strong>, news and general information about other goods, services and events which we
        ...
        <p>
          Cookies can be &ldquo;Persistent&rdquo; or &ldquo;Session&rdquo; Cookies. Persistent Cookies remain on Your personal computer or mobile
        ...
        <h3 className="text-xl font-bold mt-6 mb-2">Deletion of Your Personal Data</h3>
        <p>
          You retain the right to remove or ask for assistance in removing the Personal Data we&apos;ve gathered about you. Through
          our Service, you may have the option to erase specific information about yourself. You can modify, revise, or erase
          your details anytime by accessing your Account, if applicable, and navigating to the account settings area
          designated for managing your personal information. Alternatively, you can reach out to us to request access,
          correction, or deletion of any personal information you&apos;ve shared with us. Please be aware that we might require.
        </p>
        ...
        <p>
          ...
          update the &ldquo;Last updated&rdquo; date at the top of this Privacy Policy.
        </p>
        <p>
